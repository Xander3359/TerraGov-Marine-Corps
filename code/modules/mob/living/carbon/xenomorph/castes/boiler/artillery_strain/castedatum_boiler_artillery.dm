/datum/xeno_caste/boiler/artillery_strain
	caste_name = "Boiler"
	display_name = "Artillery"
	upgrade_name = ""
	caste_desc = "Gross!"

	caste_type_path = /mob/living/carbon/xenomorph/boiler/artillery_strain
...
/datum/xeno_caste/boiler/artillery_strain/primordial
